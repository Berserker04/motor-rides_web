...
const ServiceListPaginationPublic = ({ paginate }: props) => {
  return (
    <div className=" w-full overflow-hidden bg-white rounded-b-lg shadow-md dark:bg-gray-800">
      <nav
...
export default ServiceListPaginationPublic;
