...
import { URL_PACKAGE_BASE_ADMIN } from "@/shared/routes/index";
import { GET_IMAGE, GET_VIDEO } from "@/api/ApiConfig";

export default function ServiceCardAdmin({ data }: { data: IPackageDto }) {
  const router = useRouter();

  const showService = () => {
    router.push(`${URL_PACKAGE_BASE_ADMIN}/${data.slug}`);
  };
